...
<template>
  <div class="font-['Sora'] flex flex-col flex-1 items-center">
    <!-- Banner -->
    <div
      v-if="route.query.preview"
      class="text-white p-2 bg-weather-secondary w-full text-center text-xs font-light"
    >
      <p>
    ...
    <div class="max-w-screen-md w-full py-12">
      <div class="mx-8 text-white">
        ...
        <div class="flex gap-10 overflow-x-scroll hide-scroll">
          <div
